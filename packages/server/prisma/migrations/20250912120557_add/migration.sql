/*
  ...
  - Added the required column `expiresAt` to the `Summary` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Summary" ("content", "id", "productId") SELECT "content", "id", "productId" FROM "Summary";
DROP TABLE "Summary";
